 ...
 *
 * Per SPEC-0006 §FR-4 + §6.4 + TASKS-0006 §3.1 / §3.4. Mirror of the
 * apps/api middleware (intentional copy per TASKS-0006 §3.4 since the two
 * Express apps run independently).
 *

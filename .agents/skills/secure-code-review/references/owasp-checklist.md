...
The single most common category. Every resource access must answer: _is this caller allowed to read/write this specific object, right now, under their current role?_
